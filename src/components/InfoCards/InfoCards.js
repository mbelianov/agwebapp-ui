...
const ExamInfoCard = (props) => {
  ...
  return (
    <Tile>
      ...
      <div className="bx--row">
        <div className="bx--col exam-info-section__buttons-row">
          <Button kind="primary" >Печат</Button>
        </div>
      </div>
    </Tile>
  )
...
export { PatientInfoSection, InfoCard, ExamInfoCard };